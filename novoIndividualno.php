...
<head>
    ...
    <title>Novo individualno putovanje</title>
</head>
        ...
        <div class="row">
            ...
            <div class="col-8">
                <div class="card text-black bg-white">
                    <h3 class="card-header">Novo individualno putovanje</h3>
                    <div class="card-body">
                        <form action="php/novoIndividualno.php" method="post">
                            ...
                            <button type="button" class="btn btn-primary"><a href="individualno.php">Nazad na
